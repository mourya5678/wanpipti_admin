...
import { AddNewQuiz, UpdateNewQuiz } from '../Redux/actions/usersAction';
...
const EditFaq = () => {
    ...
    const { isLoading, isToggle } = useSelector((state) => state.authReducer);
    ...
    const onAddFaqQuestions = async (values, { setSubmitting }) => {
        ...
        dispatch(UpdateNewQuiz({ payload: values, callback, id: state?.id }));
    }
